...
<table width="920" height="319" border="0" align="center" cellpadding="0" cellspacing="0" style="background-color:#F2F2F2;">
  <tr>
...
<form name="myform" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
        ...
        <table width="96%" border="0" align="center" cellpadding="4" style=" background-image:url(style/headerStrip.jpg); background-repeat:repeat-x; border: #999 1px solid;">
          <tr>
            ...
            <input name="toggleAll" id="toggleAll" type="checkbox" onclick="toggleChecks(document.myform.cb)" />            </td>
...
?>
        <table width="96%" border="0" align="center" cellpadding="4">
          <tr>
            <td width="4%" valign="top">
            <input type="checkbox" name="cb<?php echo $row['id']; ?>" id="cb" value="<?php echo $row['id']; ?>" />            </td>
            <td width="20%" valign="top"><a href="profile.php?id=<?php echo $Sid; ?>"><?php echo $Sname; ?></a></td>
            <td width="58%" valign="top">
              <span class="toggle" style="padding:3px;">
              <a class="<?php echo $textWeight; ?>" id="subj_line_<?php echo $row['id']; ?>" style="cursor:pointer;" onclick="markAsRead(<?php echo $row['id']; ?>)"><?php echo stripslashes($row['subject']); ?></a>              </span>
...
<!-- Start PM Reply Final Message box showing user message status when needed -->    
 ...
 <!-- End PM Reply Final Message box showing user message status when needed --></td>
    <td width="188" valign="top"><br />
    <br /></td></tr>
</table>
