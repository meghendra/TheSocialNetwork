...
$queryMsg = "Showing Older to Newest members by Default";
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
if (($_POST['listByq'] == "newest_members")) {
    ...
    $queryString = "WHERE youtube !='' AND ORDER BY id DESC";
...
$sql = mysql_query("SELECT id, username, firstname, country, website FROM myMembers ORDER BY id ASC"); 
...
$sql2 = mysql_query("SELECT id, username, firstname, country, website FROM myMembers ORDER BY id ASC $limit"); 
//////////////////////////////// END Pagination Logic ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////// The Pagination Display Setup ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
<table width="900" border="0" style="background-color: #F2F2F2; border:#CCC 1px solid;" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="738" valign="top"><div></div>
      <div style="margin-left:64px; margin-right:64px;">
        <h2>Total  Members: <?php echo $nr; ?><br />
